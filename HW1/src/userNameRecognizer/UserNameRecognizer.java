	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '-' || currentChar == '_' || currentChar == '&') {		// Check for allowed special characters
					nextState = 2;
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, underscore, dash, or ampersand must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
